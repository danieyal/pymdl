...
class AsyncTransport:
    ...
    def __init__(
        ...
        *,
        ...
        self._client: Any = client or AsyncSession(
    ...
    async def request(self, prepared: PreparedRequest) -> TransportResponse:
        ...
        response = await self._client.request(prepared.method, url, **kwargs)
